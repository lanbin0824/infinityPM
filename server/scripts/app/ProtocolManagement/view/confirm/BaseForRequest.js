...
Ext.define('PM.view.confirm.BaseForRequest', {
    ...
    initComponent: function() {
        ...
        me.btnOkConfirm = Ext.create('Ext.Button', {
            ...
            handler: function() {
                ...
                var transferReasonEl = document.getElementsByClassName("Comfirm-input-request")[1];
                me.transferReasonValue = transferReasonEl.value;
                var resRpidData = "";
        ...
        me.transferOptionContainer = Ext.create('Ext.container.Container', {
            width: 500,
            height: 32,
            layout: 'hbox'
        });

        me.transferOptionImg = Ext.create('Ext.Img', {
            width: 12,
            margin: '8 5 0 21',
            style: 'cursor:pointer;',
            src: PROCESS_PATH_GLOBAL_RESOURCES + 'images/arrows/collapse.png',
            listeners : {
                render: function () {
                    Ext.fly(this.el).on('click',
                        function (e, t) {
                            if (me.transferPanel.isVisible()) {
                                me.transferOptionImg.setSrc(PROCESS_PATH_GLOBAL_RESOURCES + 'images/arrows/collapse.png');
                                me.transferPanel.hide();
                                me.setHeight(365);
                                me.center();
                            } else {
                                me.transferOptionImg.setSrc(PROCESS_PATH_GLOBAL_RESOURCES + 'images/arrows/unfold.png');
        ...
        var transferOptionLabel = Ext.create('Ext.form.Label', {
            height: 32,
            html: '<span style="cursor:pointer;font-size:14pt;">' + stringSetting.comments.button.transferOption + '<span>',
            listeners : {
                render: function () {
                    Ext.fly(this.el).on('click',
                        function (e, t) {
        ...
        me.transferOptionContainer.add(me.transferOptionImg);
        me.transferOptionContainer.add(transferOptionLabel);

        me.transferPanel = Ext.create('PM.view.confirm.TransferForRequest', {
            hidden: true,
        ...
        if ((transferPresetEnabled || me.selectProtocol.get('type') == ProtocolType.ExamPlan) && memoryProtocolShare &&
             (me.protocolAction == ProtocolAction.approve || 
              me.protocolAction == null)) {
            me.height = 365;
            //me.transferPanel.show();
            ...
            me.height = 330;
            me.transferOptionContainer.hide();
        }
    ...
    getTransferComments: function() {
        ...
        if (this.isTransfer) {
            ...
            table += stringSetting.comments.label.approveTransferlable;
            table += '</div>';
    ...
    {
        return this.transferReasonValue;
    },
    addReasonEvent: function() {
        var thisWin = this;
        var reason = document.getElementsByClassName("Comfirm-input-request")[0];
        var transferReason = document.getElementsByClassName("Comfirm-input-request")[1];
        reason.onblur = function(e) {
            ...
            {
                warningSpan.style.display = "none";
                if (thisWin.protocolAction != ProtocolAction.approve &&
                    thisWin.protocolAction != ProtocolAction.deleteProtocl) 
                {
        ...
        transferReason.onblur = function(e) {
            var reasonSpan = document.getElementById("transferSpanReason");
            var warningSpan = document.getElementById("transferSpanWarning");
            var reasonVal = this.value;
            var resonLength = this.value.length;
            if (resonLength > 0)
            {
        ...
        transferReason.onkeyup = transferReason.onblur;
