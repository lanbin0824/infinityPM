...
Ext.define('PM.view.Setting.BatchApprovingConfirmView', {
...
//-------------------------------------
    ...
    initComponent : function() {
        ...
        me.title = stringSetting.app_setting.title.approve;
    ...
    createRegionPanel:function(){
        ...
        me.name = stringSetting.app_setting.label.label_approving;
    ...
    errorApprove:function(approveStore,requestStore){
        ...
        var header = {
            ...
            "details": stringSetting.master.message.approve_error_header.format(resultApprove.length),
            "solution": "",
            "calladmin": ""
        };
        errList.push(header);
